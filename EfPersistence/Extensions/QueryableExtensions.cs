...
internal static class QueryableExtensions
{
    ...
    private static Expression NullConditional(this Expression expression, Expression body, string propertyOrField)
    {
    ...
    private static Expression GetSortBody(Expression body, string[] properties, int paramIndex = 0)
    {
        ...
        return body.NullConditional(
            GetSortBody(Expression.PropertyOrField(body, properties[0]), properties[1..]),
            properties[0]);
    }
